...
public class PayoutTransfer {
    ...
    protected JAXBElement<PayoutTransferRequestMessage> requestMessage;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PayoutTransferRequestMessage }{@code >}
     *     
     */
    public JAXBElement<PayoutTransferRequestMessage> getRequestMessage() {
     ...
     *     
     */
    public void setRequestMessage(JAXBElement<PayoutTransferRequestMessage> value) {
        this.requestMessage = ((JAXBElement<PayoutTransferRequestMessage> ) value);
    }
