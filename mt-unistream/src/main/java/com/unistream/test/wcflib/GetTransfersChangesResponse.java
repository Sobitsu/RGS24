...
public class GetTransfersChangesResponse {
    ...
    protected JAXBElement<GetTransfersChangesResponseMessage> getTransfersChangesResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetTransfersChangesResponseMessage }{@code >}
     *     
     */
    public JAXBElement<GetTransfersChangesResponseMessage> getGetTransfersChangesResult() {
     ...
     *     
     */
    public void setGetTransfersChangesResult(JAXBElement<GetTransfersChangesResponseMessage> value) {
        this.getTransfersChangesResult = ((JAXBElement<GetTransfersChangesResponseMessage> ) value);
    }
