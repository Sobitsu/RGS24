...
public class FindTransferResponse {
    ...
    protected JAXBElement<FindTransferResponseMessage> findTransferResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link FindTransferResponseMessage }{@code >}
     *     
     */
    public JAXBElement<FindTransferResponseMessage> getFindTransferResult() {
     ...
     *     
     */
    public void setFindTransferResult(JAXBElement<FindTransferResponseMessage> value) {
        this.findTransferResult = ((JAXBElement<FindTransferResponseMessage> ) value);
    }
