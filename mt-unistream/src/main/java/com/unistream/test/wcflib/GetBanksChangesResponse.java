...
public class GetBanksChangesResponse {
    ...
    protected JAXBElement<GetBanksChangesResponseMessage> getBanksChangesResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetBanksChangesResponseMessage }{@code >}
     *     
     */
    public JAXBElement<GetBanksChangesResponseMessage> getGetBanksChangesResult() {
     ...
     *     
     */
    public void setGetBanksChangesResult(JAXBElement<GetBanksChangesResponseMessage> value) {
        this.getBanksChangesResult = ((JAXBElement<GetBanksChangesResponseMessage> ) value);
    }
