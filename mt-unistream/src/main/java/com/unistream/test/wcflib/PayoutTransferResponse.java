...
public class PayoutTransferResponse {
    ...
    protected JAXBElement<PayoutTransferResponseMessageType> payoutTransferResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PayoutTransferResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<PayoutTransferResponseMessageType> getPayoutTransferResult() {
     ...
     *     
     */
    public void setPayoutTransferResult(JAXBElement<PayoutTransferResponseMessageType> value) {
        this.payoutTransferResult = value;
    }
