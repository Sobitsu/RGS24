...
public class RejectNoticeResponse {
    ...
    protected JAXBElement<RejectNoticeResponseMessage> rejectNoticeResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link RejectNoticeResponseMessage }{@code >}
     *     
     */
    public JAXBElement<RejectNoticeResponseMessage> getRejectNoticeResult() {
     ...
     *     
     */
    public void setRejectNoticeResult(JAXBElement<RejectNoticeResponseMessage> value) {
        this.rejectNoticeResult = ((JAXBElement<RejectNoticeResponseMessage> ) value);
    }
