...
public class GetNoticesListResponse {
    ...
    protected JAXBElement<GetNoticesListResponseMessage> getNoticesListResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetNoticesListResponseMessage }{@code >}
     *     
     */
    public JAXBElement<GetNoticesListResponseMessage> getGetNoticesListResult() {
     ...
     *     
     */
    public void setGetNoticesListResult(JAXBElement<GetNoticesListResponseMessage> value) {
        this.getNoticesListResult = ((JAXBElement<GetNoticesListResponseMessage> ) value);
    }
