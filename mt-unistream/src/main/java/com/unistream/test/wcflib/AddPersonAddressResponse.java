...
public class AddPersonAddressResponse {
    ...
    protected JAXBElement<AddPersonAddressResponseMessage> addPersonAddressResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AddPersonAddressResponseMessage }{@code >}
     *     
     */
    public JAXBElement<AddPersonAddressResponseMessage> getAddPersonAddressResult() {
     ...
     *     
     */
    public void setAddPersonAddressResult(JAXBElement<AddPersonAddressResponseMessage> value) {
        this.addPersonAddressResult = ((JAXBElement<AddPersonAddressResponseMessage> ) value);
    }
