...
public class AddPersonAddress {
    ...
    protected JAXBElement<AddPersonAddressRequestMessage> requestMessage;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AddPersonAddressRequestMessage }{@code >}
     *     
     */
    public JAXBElement<AddPersonAddressRequestMessage> getRequestMessage() {
     ...
     *     
     */
    public void setRequestMessage(JAXBElement<AddPersonAddressRequestMessage> value) {
        this.requestMessage = ((JAXBElement<AddPersonAddressRequestMessage> ) value);
    }
