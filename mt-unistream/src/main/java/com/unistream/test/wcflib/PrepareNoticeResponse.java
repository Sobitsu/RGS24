...
public class PrepareNoticeResponse {
    ...
    protected JAXBElement<PrepareNoticeResponseMessage> prepareNoticeResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PrepareNoticeResponseMessage }{@code >}
     *     
     */
    public JAXBElement<PrepareNoticeResponseMessage> getPrepareNoticeResult() {
     ...
     *     
     */
    public void setPrepareNoticeResult(JAXBElement<PrepareNoticeResponseMessage> value) {
        this.prepareNoticeResult = ((JAXBElement<PrepareNoticeResponseMessage> ) value);
    }
