...
public class InsertTransfer2Response {
    ...
    protected JAXBElement<InsertTransfer2ResponseMessage> insertTransfer2Result;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link InsertTransfer2ResponseMessage }{@code >}
     *     
     */
    public JAXBElement<InsertTransfer2ResponseMessage> getInsertTransfer2Result() {
     ...
     *     
     */
    public void setInsertTransfer2Result(JAXBElement<InsertTransfer2ResponseMessage> value) {
        this.insertTransfer2Result = ((JAXBElement<InsertTransfer2ResponseMessage> ) value);
    }
