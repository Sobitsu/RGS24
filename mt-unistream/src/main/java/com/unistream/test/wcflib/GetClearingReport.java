...
public class GetClearingReport {
    ...
    protected JAXBElement<GetClearingReportRequestMessage> requestMessage;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetClearingReportRequestMessage }{@code >}
     *     
     */
    public JAXBElement<GetClearingReportRequestMessage> getRequestMessage() {
     ...
     *     
     */
    public void setRequestMessage(JAXBElement<GetClearingReportRequestMessage> value) {
        this.requestMessage = ((JAXBElement<GetClearingReportRequestMessage> ) value);
    }
