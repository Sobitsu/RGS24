...
public class GetNoticesChangesResponse {
    ...
    protected JAXBElement<GetNoticesChangesResponseMessageType> getNoticesChangesResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetNoticesChangesResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<GetNoticesChangesResponseMessageType> getGetNoticesChangesResult() {
     ...
     *     
     */
    public void setGetNoticesChangesResult(JAXBElement<GetNoticesChangesResponseMessageType> value) {
        this.getNoticesChangesResult = value;
    }
