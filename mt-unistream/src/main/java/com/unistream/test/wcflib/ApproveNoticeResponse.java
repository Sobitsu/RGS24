...
public class ApproveNoticeResponse {
    ...
    protected JAXBElement<ApproveNoticeResponseMessage> approveNoticeResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ApproveNoticeResponseMessage }{@code >}
     *     
     */
    public JAXBElement<ApproveNoticeResponseMessage> getApproveNoticeResult() {
     ...
     *     
     */
    public void setApproveNoticeResult(JAXBElement<ApproveNoticeResponseMessage> value) {
        this.approveNoticeResult = ((JAXBElement<ApproveNoticeResponseMessage> ) value);
    }
