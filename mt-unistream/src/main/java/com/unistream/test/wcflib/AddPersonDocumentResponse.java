...
public class AddPersonDocumentResponse {
    ...
    protected JAXBElement<AddPersonDocumentResponseMessageType> addPersonDocumentResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AddPersonDocumentResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<AddPersonDocumentResponseMessageType> getAddPersonDocumentResult() {
     ...
     *     
     */
    public void setAddPersonDocumentResult(JAXBElement<AddPersonDocumentResponseMessageType> value) {
        this.addPersonDocumentResult = value;
    }
