...
public class GetTransfersList {
    ...
    protected JAXBElement<GetTransfersListRequestMessageType> requestMessage;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetTransfersListRequestMessageType }{@code >}
     *     
     */
    public JAXBElement<GetTransfersListRequestMessageType> getRequestMessage() {
     ...
     *     
     */
    public void setRequestMessage(JAXBElement<GetTransfersListRequestMessageType> value) {
