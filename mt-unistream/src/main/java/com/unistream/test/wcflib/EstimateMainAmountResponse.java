...
public class EstimateMainAmountResponse {
    ...
    protected JAXBElement<EstimateMainAmountResponseMessageType> estimateMainAmountResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link EstimateMainAmountResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<EstimateMainAmountResponseMessageType> getEstimateMainAmountResult() {
     ...
     *     
     */
    public void setEstimateMainAmountResult(JAXBElement<EstimateMainAmountResponseMessageType> value) {
        this.estimateMainAmountResult = value;
    }
