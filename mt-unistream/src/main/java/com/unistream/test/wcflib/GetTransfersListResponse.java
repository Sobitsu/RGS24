...
public class GetTransfersListResponse {
    ...
    protected JAXBElement<GetTransfersListResponseMessageType> getTransfersListResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetTransfersListResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<GetTransfersListResponseMessageType> getGetTransfersListResult() {
     ...
     *     
     */
    public void setGetTransfersListResult(JAXBElement<GetTransfersListResponseMessageType> value) {
        this.getTransfersListResult = value;
    }
