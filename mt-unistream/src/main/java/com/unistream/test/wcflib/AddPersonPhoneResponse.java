...
public class AddPersonPhoneResponse {
    ...
    protected JAXBElement<AddPersonPhoneResponseMessageType> addPersonPhoneResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AddPersonPhoneResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<AddPersonPhoneResponseMessageType> getAddPersonPhoneResult() {
     ...
     *     
     */
    public void setAddPersonPhoneResult(JAXBElement<AddPersonPhoneResponseMessageType> value) {
        this.addPersonPhoneResult = value;
    }
