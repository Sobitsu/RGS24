...
public class IdentifyPersonByCardResponse {
    ...
    protected JAXBElement<IdentifyPersonByCardResponseMessageType> identifyPersonByCardResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link IdentifyPersonByCardResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<IdentifyPersonByCardResponseMessageType> getIdentifyPersonByCardResult() {
     ...
     *     
     */
    public void setIdentifyPersonByCardResult(JAXBElement<IdentifyPersonByCardResponseMessageType> value) {
        this.identifyPersonByCardResult = value;
    }
