...
public class ReturnTransferResponse {
    ...
    protected JAXBElement<ReturnTransferResponseMessage> returnTransferResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ReturnTransferResponseMessage }{@code >}
     *     
     */
    public JAXBElement<ReturnTransferResponseMessage> getReturnTransferResult() {
     ...
     *     
     */
    public void setReturnTransferResult(JAXBElement<ReturnTransferResponseMessage> value) {
        this.returnTransferResult = ((JAXBElement<ReturnTransferResponseMessage> ) value);
    }
