...
public class GetTransferBySourceIDResponse {
    ...
    protected JAXBElement<GetTransferBySourceIDResponseMessageType> getTransferBySourceIDResult;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link GetTransferBySourceIDResponseMessageType }{@code >}
     *     
     */
    public JAXBElement<GetTransferBySourceIDResponseMessageType> getGetTransferBySourceIDResult() {
     ...
     *     
     */
    public void setGetTransferBySourceIDResult(JAXBElement<GetTransferBySourceIDResponseMessageType> value) {
        this.getTransferBySourceIDResult = value;
    }
