...
public class CommonLib {
        ...
        public static JAXBElement<AuthenticationHeaderType> MakeAuthHead()
                {
                    ...
                    AuthenticationHeaderType ah = factory.createAuthenticationHeaderType();
                    JAXBElement<AuthenticationHeaderType> ahh = factory.createWsRequestAuthenticationHeader(ah);
                    ah.setAppKey(factory.createAuthenticationHeaderTypeAppKey(Constants.KEY_USER_AUTHED_APIKEY));
                    ah.setUsername(factory.createAuthenticationHeaderTypeUsername(Constants.KEY_USER_AUTHED_LOGIN));
                    ah.setPassword(factory.createAuthenticationHeaderTypePassword(Constants.KEY_USER_AUTHED_PASSWORD));
                    return ahh;
                }
