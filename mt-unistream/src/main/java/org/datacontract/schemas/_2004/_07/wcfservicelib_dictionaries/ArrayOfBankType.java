...
@XmlType(name = "ArrayOfBank", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLib.Dictionaries.Bank", propOrder = {
    "bank"
})
public class ArrayOfBankType {

    @XmlElement(name = "Bank", nillable = true)
    protected List<BankType> bank;
