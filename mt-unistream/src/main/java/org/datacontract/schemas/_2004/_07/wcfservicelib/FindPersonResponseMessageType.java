...
public class FindPersonResponseMessageType
    extends WsResponse
{
    ...
    protected JAXBElement<ArrayOfPersonType> persons;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfPersonType }{@code >}
     *     
     */
    public JAXBElement<ArrayOfPersonType> getPersons() {
        return persons;
    }
     ...
     *     
     */
    public void setPersons(JAXBElement<ArrayOfPersonType> value) {
        this.persons = value;
    }
