...
public class ArrayOfNoticeListItemType {

    @XmlElement(name = "NoticeListItem", nillable = true)
    protected List<NoticeListItemType> noticeListItem;
     ...
     * {@link NoticeListItemType }
     * 
     * 
     */
    public List<NoticeListItemType> getNoticeListItem() {
        if (noticeListItem == null) {
            noticeListItem = new ArrayList<NoticeListItemType>();
        }
