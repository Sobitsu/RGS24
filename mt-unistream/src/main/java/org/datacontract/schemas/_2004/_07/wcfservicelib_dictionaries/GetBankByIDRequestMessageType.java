...
@XmlType(name = "GetBankByIDRequestMessage", namespace = "http://schemas.datacontract.org/2004/07/WcfServiceLib.Dictionaries.Bank", propOrder = {
    "id"
})
public class GetBankByIDRequestMessageType
    extends WsRequest
{
