...
public class AddPersonDocumentRequestMessage
    extends WsRequest
{
    ...
    protected JAXBElement<Document> newPersonDocument;
     ...
     *     
     */
    public JAXBElement<Document> getNewPersonDocument() {
     ...
     *     
     */
    public void setNewPersonDocument(JAXBElement<Document> value) {
        this.newPersonDocument = ((JAXBElement<Document> ) value);
    }
