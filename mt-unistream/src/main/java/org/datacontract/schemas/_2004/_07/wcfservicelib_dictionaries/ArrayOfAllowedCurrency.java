...
@XmlType(name = "ArrayOfAllowedCurrency", propOrder = {
    "allowedCurrency"
})
public class ArrayOfAllowedCurrency {

    @XmlElement(name = "AllowedCurrency", nillable = true)
    protected List<AllowedCurrency> allowedCurrency;
     ...
     * {@link AllowedCurrency }
     * 
     * 
     */
    public List<AllowedCurrency> getAllowedCurrency() {
        if (allowedCurrency == null) {
            allowedCurrency = new ArrayList<AllowedCurrency>();
        }
