...
public class ArrayOfParticipator {

    @XmlElement(name = "Participator", nillable = true)
    protected List<Participator> participator;
     ...
     * 
     */
    public List<Participator> getParticipator() {
        if (participator == null) {
            participator = new ArrayList<Participator>();
        }
