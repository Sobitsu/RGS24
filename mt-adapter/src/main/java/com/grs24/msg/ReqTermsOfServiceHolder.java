...
public class ReqTermsOfServiceHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(ReqTermsOfServiceHolder.class.getName());
    ...
    public ReqTermsOfServiceHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("ReqTermsOfService(");
