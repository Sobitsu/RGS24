...
public class AnsExtInfoHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsExtInfoHolder.class.getName());
    ...
    public AnsExtInfoHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsExtInfo(");
