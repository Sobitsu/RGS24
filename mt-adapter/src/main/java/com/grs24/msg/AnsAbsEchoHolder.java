...
public class AnsAbsEchoHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsAbsEchoHolder.class.getName());
    ...
    public AnsAbsEchoHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsAbsEcho(");
