...
public class AnsCfgInfoHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsCfgInfoHolder.class.getName());

    private String stan;
    private String timeStamp;
    private CfgDataHolder cfgData;
    ...
    public void setCfgData(CfgDataHolder CfgData) {
        this.cfgData = CfgData;
    }

    public CfgDataHolder getCfgData() {
        return this.cfgData;
    }
    ...
    public AnsCfgInfoHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsCfgInfo(");
        str.append(" stan=").append(getStan());
        str.append(" timeStamp=").append(getTimeStamp());
        str.append(" cfgData=").append(getCfgData());
