...
public class AnsPayBeginHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsPayBeginHolder.class.getName());
    ...
    public AnsPayBeginHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsPayBegin(");
