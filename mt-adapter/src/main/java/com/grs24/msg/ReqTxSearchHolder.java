...
public class ReqTxSearchHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(ReqTxSearchHolder.class.getName());
    ...
    public void setFilter(FilterHolder Filter) {
        this.filter = Filter;
    }
    ...
    public ReqTxSearchHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("ReqTxSearch(");
        ...
        str.append(" filter=").append(getFilter());
