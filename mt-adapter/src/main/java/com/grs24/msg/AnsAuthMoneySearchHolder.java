...
public class AnsAuthMoneySearchHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsAuthMoneySearchHolder.class.getName());

    private String stan;
    private String timeStamp;
    private MtBriefHolder[] mtBrief;
    ...
    public void setMtBrief(MtBriefHolder[] MtBrief) {
        this.mtBrief = MtBrief;
    }

    public MtBriefHolder[] getMtBrief() {
        return this.mtBrief;
    }
    ...
    public AnsAuthMoneySearchHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsAuthMoneySearch(");
        str.append(" stan=").append(getStan());
        str.append(" timeStamp=").append(getTimeStamp());
        if ( getMtBrief() != null )
            for (int i=0; i < getMtBrief().length; i++) {
                str.append(" mtBrief["+i+"]=").append(getMtBrief()[i]);
            }
