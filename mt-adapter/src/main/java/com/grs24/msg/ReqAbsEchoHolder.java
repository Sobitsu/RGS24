...
public class ReqAbsEchoHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(ReqAbsEchoHolder.class.getName());
    ...
    public ReqAbsEchoHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("ReqAbsEcho(");
