...
public class AnsMoneySearchHolder implements Stickable {
    protected static Logger syslog = Logger.getLogger(AnsMoneySearchHolder.class.getName());
    ...
    public AnsMoneySearchHolder() {
    }

    public String toString() {
        StringBuffer str = new StringBuffer();
        str.append("AnsMoneySearch(");
